...
- **Hidden when reading:** breadcrumb `<nav>`, steer `<section data-tour="steer">`,
  branches `<section data-tour="branches">`, the Atlas FAB, and the app header.
- **Shown when reading:** only the passage frame (title + prose) + the close button.
